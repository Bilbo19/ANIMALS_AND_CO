...
animal = Animal.new(
  ...
  address: '5 Rue Crespin du Gast, 75011 Paris',
  user_id: user1.id,
  photo_url: "https://www.wildlifearchives.com/wp-content/uploads/2018/01/whales-most-beautiful-picture-1516721809gkn48.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://secure.img1-cg.wfcdn.com/im/87624362/compr-r85/1539/153900257/standing-donkey-statue.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://i.pinimg.com/originals/04/f2/f8/04f2f89aa366ce677fa28fdfe0d6d7a2.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://media.istockphoto.com/id/453082743/fr/photo/golden-eagle.jpg?s=612x612&w=0&k=20&c=Q75BuJdYYh2C79RolaLjSDAArBBwvoaoQH06xZaH0y0="
)
animal.save!
...
animal = Animal.new(
  ...
  address: '263 Boulevard Voltaire, 75011 Paris',
  user_id: user1.id,
  photo_url: "https://www.earthtouchnews.com/media/1281943/02042015-_MG_0501.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://preview.redd.it/52ialyqvcxg51.jpg?width=640&crop=smart&auto=webp&s=07d5c20f5f947484d8f6edfd030c5ad17ddfe5d4"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://thumbs.dreamstime.com/b/sardines-9818904.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://www.jardiland.com/wp-content/uploads/2017/12/nourrir-carpes-koi-1.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://a-z-animals.com/media/2021/12/Beautiful-Green-Animals-Red-Eyed-Tree-Frog.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "http://pyrros.fr/wp-content/uploads/2017/03/IMG_9412-Salamandre-tachet%C3%A9e.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  address: '51 Rue Guy Moquet, 75017 Paris',
  user_id: user1.id,
  photo_url: "https://images.unsplash.com/photo-1568526381923-caf3fd520382?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mnx8fGVufDB8fHx8&w=1000&q=80"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://en.bcdn.biz/Images/2016/12/1/47d501a8-93d2-4560-91a2-6f22386bf9c4.jpg"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://4.bp.blogspot.com/-lzuGKv1gQKs/Vgz1stkZvOI/AAAAAAAAAms/7tClxaa__Gg/s1600/Dragons%2Bare%2BReal.%2BFlying%2BDragon.png"
)
animal.save!
...
animal = Animal.new(
  ...
  user_id: user1.id,
  photo_url: "https://top10animal.com/wp-content/uploads/2021/07/unicorn3.jpg"
)
animal.save!
